...
export interface DisabilityProvisionsProps {
  /**
   * Search text
   */
  searchText: string;
...
const DisabilityProvisions = (props: DisabilityProvisionsProps) => {
  ...
  return (
    <Grid container direction="column">
      <FileDownloadCard title="Disability Provisions" files={finalFilteredLinks} />
    </Grid>
  );
};

export default DisabilityProvisions;
