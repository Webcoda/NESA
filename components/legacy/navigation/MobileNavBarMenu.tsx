...
import { ChevronLeft, ChevronRight, LinkedIn, Twitter, YouTube } from '@material-ui/icons';
import { useHistory } from 'react-router-dom';
import Flickr from '../../assets/images/flickr.svg';
import { UrlLinkWithChildrenFlag } from '../../utilities/frontendTypes';
import PATHS from '../../constants/pathConstants';
import SearchBar, { SearchBarProps } from '../base/SearchBar';
...
const MobileNavBarMenu = (props: MobileNavBarMenuProps): JSX.Element => {
  const { sections, currentHeading, autoFocusSearchBar, onBack, onClick, onSearchSubmit } = props;
  ...
  return (
    <div className="mobile-navbar-menu">
      {currentHeading ? (
        <Button className="mobile-navbar-menu__section" onClick={onBack}>
            ...
            return (
              <Button
                className={`mobile-navbar-menu__section ${
                  link.hasChildren ? 'mobile-navbar-menu__section--more' : ''
                }`}
              ...
              >
                <span className="mobile-navbar-menu__link">
                  ...
                  {link.icon && <span className="mobile-navbar-menu__link-icon">{link.icon}</span>}
                </span>
      ...
      <div className="mobile-navbar-menu__footer">
        ...
        <Grid container justifyContent="flex-end" className="mobile-navbar-menu__icons">
          {/* TODO: Enable after MVP */}
