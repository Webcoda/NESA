...
import useNavGroups, { NavGroup } from '../../utilities/hooks/useNavGroups';
...
export const PureMobileHeader = (props: PureMobileHeaderProps): JSX.Element => {
  ...
  return (
    <div className={`mobile-header ${className || ''}`} ref={header}>
      <MobileNavBar onClickMenu={onClickMenu} onClickSearch={onClickSearch} />
...
export type MobileHeaderProps = Pick<PureMobileHeaderProps, 'onSearch' | 'className'>;
