 ...
 * @property {string}   headline           - Title for card
 ...
 */
export const CardContent = ({ className, children, link, ...attributesOptions }) => (
	<div className={`nsw-card__content ${className}`} {...attributesOptions}>
		{children}
		{
			link ? (
				<span className="material-icons nsw-material-icons nsw-card__icon" focusable="false" aria-hidden="true">
					east
				</span>
			) : ''
		}
